...
This implements a valid closed testing procedure following Goeman's
methodology that ensures proper FWER control by testing all intersection
hypotheses.
...
- method:
  ...
  Method for combining p-values in intersections ("simes", "fisher",
  "min")
...
Goeman, J. J., & Finos, L. (2012). The inheritance procedure: multiple
testing of tree-structured hypotheses. Statistical Applications in
Genetics and Molecular Biology, 11(1).
