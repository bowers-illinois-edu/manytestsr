...
```{r goeman-closed-testing, eval=FALSE}
...
```{r meinshausen-hierarchical, eval=FALSE}
...
```{r meinshausen-comparison, eval=FALSE}
...
```{r method-visualization, eval=FALSE}
