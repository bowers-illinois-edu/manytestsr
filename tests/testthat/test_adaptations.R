...
## Now we should see (1) higher p-values on the local adjusted tests and (2) fewer leaves reached.
...
## adjustments to allow Looks like some of them go all the way and others stop
## like the unadjusted.
